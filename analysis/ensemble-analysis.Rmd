...
ggplot(data = original_sc1_plot_data) +
  ggbeeswarm::geom_beeswarm(aes(x = model, y = prediction), priority = "density", size = 0.1, cex = 0.2) +
theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5))
...
new_order <- c("Team Shirin", "Hongyang Li and Yuanfang Guan", "csabaibio", "Nc717", "zs_aicoe",
               ...
               "kichuDL","vladyorsh" ,"Aboensis V", "Zbigniew Wojna", "RA2 Baseline Model")
