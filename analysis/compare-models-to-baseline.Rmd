...
par(mar = c(3,14,3,1))
boxplot(
  boot.sc1[,ncol(boot.sc1):1],
  main = "SC1 - Bootstrapped Sum Error",
  horizontal = T, 
  las = 1, 
  outline = F,
  col = "#56B4E9"
...
boxplot(
  boot.sc1[,6:1],
  main = "SC1 - Top 6 Bootstrapped Sum Error",
  horizontal = T, 
  las = 1, 
  outline = F,
  col = "#56B4E9"
...
boxplot(
  boot.sc2[,ncol(boot.sc2):1],
  main = "SC2 - Bootstrapped Joint Sum RMSE",
  horizontal = T, 
  las = 1, 
  outline = F,
  col = "#56B4E9"
...
boxplot(
  boot.sc3[,ncol(boot.sc3):1],
  main = "SC3 - Bootstrapped Joint Sum RMSE",
  horizontal = T, 
  las = 1, 
  outline = F,
  col = "#56B4E9"
