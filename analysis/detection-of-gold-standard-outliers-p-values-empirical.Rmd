...
We are calculating p-values for SC2, and SC3, using a binning and empirical approach to ensure that we have enough statistical power for each measurement. 
...
ggplot(data = submission_sc2) +
   geom_boxplot(aes(x = as_factor(bin), y = mean_score))
